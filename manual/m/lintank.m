...
% unpack the information from the input arguments and assign it to the correct variables
mmsodaUnpack()
...
% transpose 'rec' because the output argument 'modelOutput' must have 'nOutputs' rows
% and nPrior columns
rec = rec';
% find the columns in the transposed 'rec' array that contain the values of 'state1' and
% 'state2' at the times listed in 'priorTimes':
