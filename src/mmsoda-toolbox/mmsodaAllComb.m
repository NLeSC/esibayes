function A = mmsodaAllComb(varargin)
%
% <a href="matlab:web(fullfile(mmsodaroot,'html','mmsodaAllComb.html'),'-helpbrowser')">View HTML documentation for this function in the help browser</a>    
%
