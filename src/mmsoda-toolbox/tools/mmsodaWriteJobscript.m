...
'echo',char(10),...
char(10),...
'echo ',char(34),'I detected that ',char(34),'`hostname`',char(34),' has ',char(34),'$ncpus',char(34),' processors. I',char(39),'ll start ',char(34),'(($nprocs+1))',char(34),' processes.',char(34),'',char(10),...
'echo',char(10),...
...
'done',char(10),...
'echo ',char(34),'Starting interactive MPI job on ',char(34),'$nnodes',char(34),' batch nodes with a total of ',char(34),'(($nprocs+1))',char(34),' CPUs.',char(34),char(10),...
