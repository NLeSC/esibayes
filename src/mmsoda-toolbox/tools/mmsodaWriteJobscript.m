...
'echo ',char(10),...
'echo ------------------------------------------------------',char(10),...
'echo result of "ssh $nodename ''cat /proc/cpuinfo''":',char(10),...
'cat /proc/cpuinfo',char(10),...
'echo ------------------------------------------------------',char(10),...
'echo',char(10),...
...
'    echo ',char(34),'node ',char(34),'$nodename',char(34),' has ',char(34),'$ncpus',char(34),' CPUs. Here is some detailed information on each CPU:',char(34),char(10),...
'    ssh $nodename ''cat /proc/cpuinfo''',char(10),...
