...
'echo',char(10),...
char(10),...
'echo ',char(34),'Result of ',char(39),'ldd libmmpi',char(39),' is:',char(34),char(10),...
'ldd libmmpi',char(10),...
'echo',char(10),...
char(10),...
'echo ',char(34),'Result of ',char(39),'nm libmmpi',char(39),' is:',char(34),char(10),...
'nm libmmpi',char(10),...
'echo',char(10),...
char(10),...
...
'echo',char(10),...
'echo ',char(34),'Starting MPI run',char(34),'',char(10),...
'mpirun -n $nprocs -hostfile $TMPDIR/myhostfile $PBS_O_WORKDIR/matlabprog -v %d %s',char(10),...
];
