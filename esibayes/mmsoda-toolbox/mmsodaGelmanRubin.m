function rHatRoot = mmsodaGelmanRubin(conf,sequences)
%
% <a href="matlab:web(fullfile(mmsodaroot,'html','mmsodaGelmanRubin.html'),'-helpbrowser')">View HTML documentation for this function in the help browser</a>    
%
