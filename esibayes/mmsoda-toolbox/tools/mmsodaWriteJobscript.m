...
'module list',char(10),...
char(10),...
'if [ -d ',char(34),mcrFolderName,char(34),' ]; then',char(10),...
'    echo ',char(34),'Directory ',char(34),mcrFolderName,char(34),' already exists...emptying contents.',char(34),'',char(10),...
'    rm -rf ',char(34),mcrFolderName,char(34),'',char(10),...
'    echo',char(10),...
'fi',char(10),...
'echo ',char(34),'Making directory: ',mcrFolderName,char(34),'',char(10),...
'mkdir ',char(34),mcrFolderName,char(34),'',char(10),...
'echo',char(10),...
char(10),...
'echo ',char(34),'Setting MCR_CACHE_ROOT to: ',mcrFolderName,char(34),'',char(10),...
'export MCR_CACHE_ROOT=',char(34),mcrFolderName,char(34),'',char(10),...
'echo',char(10),...
char(10),...
