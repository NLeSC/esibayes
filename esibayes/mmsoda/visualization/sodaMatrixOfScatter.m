function varargout = sodaMatrixOfScatter(conf,typeStr,sequences,metropolisRejects,varargin)
...
if nargin==0
    ...
    disp([char(10),' % Usage is: ',char(10),...
             ' % sodaMatrixOfScatter(conf,typeStr,sequences,metropolisRejects,<param>,<value>)',char(10),...
             ' % ',char(10),...
